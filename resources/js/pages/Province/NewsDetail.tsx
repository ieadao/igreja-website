...
import type { Province, NewsItem } from '@/types';
...
export default function ProvinceNewsDetail({ province, article, related }: Props) {
    ...
    return (
        <ProvinceLayout province={province}>
            <Head title={`${article.title} — ${province.name}`} />
